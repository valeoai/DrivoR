...
class SceneLoader:
    ...
    def __init__(
        ...
        :param img_perturb: optional callable (np.ndarray) -> np.ndarray applied to each camera image after loading.
        """
